...
var updateSeekBarWhileSongPlays = function(){
    if (currentSoundFile) {
        currentSoundFile.bind('timeupdate', function(event){
            ...
            ssetCurrentTimeInPlayerBar(filterTimeCode(currentTime));
        });
    }
};
...
var filterTimeCode = function(timeInSeconds){
    var songSeconds = Number.parseFloat(timeInSeconds)
    var songWholeSeconds = Math.floor(songSeconds);
    var songMinutes = Math.floor(songWholeSeconds / 60);

    var remainingSeconds = songWholeSeconds % 60;
    var output = songMinutes + ':';
